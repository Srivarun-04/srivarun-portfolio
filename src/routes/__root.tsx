...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Srivarun Manthena" },
      { name: "twitter:card", content: "summary_large_image" },
      { title: "Srivarun Manthena" },
      { property: "og:title", content: "Srivarun Manthena" },
      { name: "twitter:title", content: "Srivarun Manthena" },
